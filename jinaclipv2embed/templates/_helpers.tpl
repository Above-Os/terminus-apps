...
{{- define "jinaclipv2embed.embedTag" -}}v0.2.1{{- end -}}
...
{{- has (include "jinaclipv2embed.gpuType" .) (list "intel" "intel-gpu") -}}
{{- end -}}

{{- define "jinaclipv2embed.modelId" -}}jina-clip-v2-split{{- end -}}
