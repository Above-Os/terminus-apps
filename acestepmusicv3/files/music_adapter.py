...
def _draft_query(task: dict[str, Any], attempt: int) -> str:
    ...
    anchors = {
        "zh": (
            ...
            "普通话歌曲。请直接用自然、可读的中文汉字写歌词，不要使用拼音或其他拉丁字母。必须有完整Verse、Chorus及连贯情绪发展，不写占位词或循环句。主题与风格：",
            "以中文演唱。歌词只写自然中文汉字，包含具体故事、清晰段落发展和有意义的副歌；不要拼音、外语、术语罗列或无意义重复。主题与风格：",
        ),
        "yue": (
            "粤语歌曲。内部歌词优先使用ACE标准发音脚本：每句以[yue]开头，只写带1-5声调数字的粤语音节；也可直接写自然粤语汉字。创作完整具体的情节和情绪发展。主题与风格：",
            "广东话歌曲。请直接用自然、可读的粤语汉字写歌词，不要使用拼音或其他拉丁字母。必须有完整段落和连贯情绪发展。主题与风格：",
            "以粤语演唱。歌词只写自然粤语汉字，包含具体故事、清晰段落发展和有意义的副歌；不要拼音、外语或无意义重复。主题与风格：",
        ),
    }
