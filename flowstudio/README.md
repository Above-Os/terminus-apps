...
Current Chart version: **0.3.71** (must match `Chart.yaml` / `OlaresManifest.yaml`).
...
covers 0.3.71. This chart ships `docker.io/beclab/flowstudio:0.3.71` and `engine-1.0.8`.
