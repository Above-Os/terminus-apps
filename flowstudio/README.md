...
Current Chart version: **0.3.55** (must match `Chart.yaml` / `OlaresManifest.yaml`).
...
covers 0.3.55. This chart ships `docker.io/beclab/flowstudio:0.3.55` and `engine-1.0.7`.
