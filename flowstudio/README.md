...
Current Chart version: **0.3.69** (must match `Chart.yaml` / `OlaresManifest.yaml`).
...
covers 0.3.69. This chart ships `docker.io/beclab/flowstudio:0.3.69` and `engine-1.0.8`.
