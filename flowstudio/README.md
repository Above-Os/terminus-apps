...
Current Chart version: **0.3.46** (must match `Chart.yaml` / `OlaresManifest.yaml`).
...
covers 0.3.46. This chart ships `docker.io/beclab/flowstudio:0.3.46` and `engine-1.0.6`.
