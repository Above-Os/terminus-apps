...
Current Chart version: **0.3.54** (must match `Chart.yaml` / `OlaresManifest.yaml`).
...
covers 0.3.54. This chart ships `docker.io/beclab/flowstudio:0.3.54` and `engine-1.0.7`.
