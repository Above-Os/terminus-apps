...
Current Chart version: **0.3.75** (must match `Chart.yaml` / `OlaresManifest.yaml`).
...
covers 0.3.75. This chart ships `docker.io/beclab/flowstudio:0.3.75` and `engine-1.0.8`.
