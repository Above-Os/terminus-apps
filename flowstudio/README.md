...
Current Chart version: **0.3.45** (must match `Chart.yaml` / `OlaresManifest.yaml`).
...
covers 0.3.45. This chart ships `docker.io/beclab/flowstudio:0.3.45` and `engine-1.0.6`.
