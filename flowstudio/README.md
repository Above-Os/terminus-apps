...
Current Chart version: **0.3.44** (must match `Chart.yaml` / `OlaresManifest.yaml`).
...
covers 0.3.44. This chart ships `docker.io/beclab/flowstudio:0.3.44` and `engine-1.0.6`.
