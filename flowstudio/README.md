...
Current Chart version: **0.3.74** (must match `Chart.yaml` / `OlaresManifest.yaml`).
...
covers 0.3.74. This chart ships `docker.io/beclab/flowstudio:0.3.74` and `engine-1.0.8`.
