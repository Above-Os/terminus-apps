...
Current Chart version: **0.3.72** (must match `Chart.yaml` / `OlaresManifest.yaml`).
...
covers 0.3.72. This chart ships `docker.io/beclab/flowstudio:0.3.72` and `engine-1.0.8`.
