...
{{- $cpuPreset := "-c 32768 -fa on --jinja -np 1 --kv-unified -b 512 -ub 128 -t 8" -}}
{{- $known := list "" "-c 32768 -ngl all -fa on --jinja -np 2 --kv-unified" "-c 98304 -ngl all -fa on --jinja -np 1 --kv-unified -ctk q8_0 -ctv q8_0 -b 512 -ub 128" "-c 32768 -ngl all -fa on --jinja -np 1 --kv-unified -b 512 -ub 128" $nvidiaPreset $cpuPreset -}}
{{- $preset := $nvidiaPreset -}}
