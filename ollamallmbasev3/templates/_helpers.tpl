...
{{- end -}}
{{- end -}}
{{- /* Bare -1 normalized at runtime in ollama.sh. */ -}}
...
{{- /* ollamallmbasev3.engineArgsForLlminit: daemon ENGINE_ARGS without
       OLLAMA_KEEP_ALIVE. llm-init injects that key into /api/chat as keep_alive;
       Ollama 0.31+ rejects bare string "-1" and overrides server env when set.
